...
void populate_maps(void)
{
  ...
  s_stage_map[JFIF_DQT] = {"Define Quantization Table", process_func_quant_table};
  s_stage_map[JFIF_SOF] = {"Start of Frame", process_func_start_of_frame};
  s_stage_map[JFIF_DHT] = {"Define Huffman Table", process_func_huffman_table};
...
void process_func_start_of_image(unsigned char byte)
{
}

void process_func_app_segment_0(unsigned char byte)
{
}

void process_func_quant_table(unsigned char byte)
{
}

void process_func_start_of_frame(unsigned char byte)
{
}

void process_func_huffman_table(unsigned char byte)
{
}

void process_func_start_of_scan(unsigned char byte)
{
}

void process_func_end_of_image(unsigned char byte)
{
}
